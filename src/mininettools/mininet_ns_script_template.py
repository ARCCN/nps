...
def gen_mn_ns_script_by_template(file, nodes_ext_intf, node_group, edge_group,
    ...
    file.write("from mininet.topo import SingleSwitchTopo, LinearTopo, SingleSwitchReversedTopo\n")
    file.write("from mininet.topolib import TreeTopo\n")
    file.write("from mininet.util import custom, customConstructor\n")
    ...
    file.write("        Net = services.wrpMininet\n")
    file.write("\n")
