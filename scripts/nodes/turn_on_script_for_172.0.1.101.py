...
class MyTopo( Topo ):
    ...
    def __init__( self ):
        ...
        h7 = self.addHost( 'h7', ip='1.2.3.17/16' )
        h8 = self.addHost( 'h8', ip='1.2.3.18/16' )
        h9 = self.addHost( 'h9', ip='1.2.3.19/16' )
        s22 = self.addSwitch( 's22' )
        h28 = self.addHost( 'h28', ip='1.2.3.20/16' )
        ...
        self.addLink( s22, h28, delay='5ms')
